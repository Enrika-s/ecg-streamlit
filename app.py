                ...
                with st.spinner('Analyzing data... ❤️'):
                    ...
                    if processed_data is not None:
                        ...
                        if prediction[0] == 0:
                            ...
                            **Please note**: While our model has a **confidence level of {confidence_score:.2f}%** in your predicted results (read more about what that number means <a class="highlight-link" href="https://www.capitalheart.sg/what-does-an-abnormal-ecg-mean/">here</a>), it does have limitations:
